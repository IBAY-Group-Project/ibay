...
added shipping address, posrcode, phone and deliveryDate in the orders table

every order delivery date is 5 business days from order date

order card has more fields 
